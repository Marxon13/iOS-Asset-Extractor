...
- (CUINamedLookup *)namedLookupWithName:(id)arg1 scaleFactor:(double)arg2;
- (CUINamedLookup *)namedLookupWithName:(id)arg1 scaleFactor:(double)arg2 deviceIdiom:(long long)arg3 deviceSubtype:(unsigned long long)arg4 sizeClassHorizontal:(long long)arg5 sizeClassVertical:(long long)arg6;
...
- (CUINamedLayerStack *)layerStackWithName:(id)arg1 scaleFactor:(double)arg2 deviceIdiom:(long long)arg3 deviceSubtype:(unsigned long long)arg4 sizeClassHorizontal:(long long)arg5 sizeClassVertical:(long long)arg6;
- (CUINamedLayerStack *)layerStackWithName:(id)arg1 scaleFactor:(double)arg2 deviceIdiom:(long long)arg3;
- (CUINamedLayerStack *)layerStackWithName:(id)arg1;
- (struct CGPDFDocument *)pdfDocumentWithName:(id)arg1;
- (void)enumerateNamedLookupsUsingBlock:(CDUnknownBlockType)arg1;
- (NSArray<CUINamedImage *> *)imagesWithName:(NSString *)arg1;
...
- (CUINamedImageAtlas *)parentNamedImageAtlastForImageNamed:(id)arg1 scaleFactor:(double)arg2;
- (CUINamedImageAtlas *)namedImageAtlasWithName:(id)arg1 scaleFactor:(double)arg2;
- (CUINamedImageAtlas *)namedImageAtlasWithName:(id)arg1 scaleFactor:(double)arg2 deviceIdiom:(long long)arg3 deviceSubtype:(unsigned long long)arg4 memoryClass:(unsigned long long)arg5 graphicsClass:(unsigned long long)arg6 graphicsFallBackOrder:(id)arg7;
- (CUINamedData *)dataWithName:(id)arg1;
- (CUINamedData *)dataWithName:(id)arg1 deviceIdiom:(long long)arg2 deviceSubtype:(unsigned long long)arg3 memoryClass:(unsigned long long)arg4 graphicsClass:(unsigned long long)arg5 graphicsFallBackOrder:(id)arg6;
- (CUINamedData *)dataWithName:(id)arg1 deviceIdiom:(long long)arg2 deviceSubtype:(unsigned long long)arg3 memoryClass:(unsigned long long)arg4 graphicsClass:(unsigned long long)arg5;
